...
2018-至今 维护开源项目前端**每日时报** GitHub 1.5K Star（更新 340 天）；  
...
擅长**前端工程化/自动化**，如：数据大屏、运营活动生成器、业务组件平台、区块平台、开发提效工具（气泡）、UI 工具（Low Code）、前端规范、工程测试、VSCode 辅助插件、脚手架等。
...
1. 组建前端团队，负责人员招聘和人才培养，培养共计 9 人。
2. 负责前端基础建设，基础设施如规范制度、文档服务、基础框架、物料库、UI 库，前后端协同工具等核心模块的开发和指导。
...
负责禧云中台业务系统搭建，整合多渠道的合作系统，多 iSV 服务供应系统，从而快速推进线下业务，主要的系统如下：
