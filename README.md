...
2015 年在 200 人的研发团队晋升到研发经理（P7），目前是禧云信息的前端负责人。一线带队经验 5 年，期间培养了三名 P5 级工程师，五名 P6 级工程师。  

擅长**前端基础建设**打造开源项目**禧云前端生态**，减轻 iSV 入驻成本。  

深度参与业务，对标蚂蚁的**大中台体系建设**有着非常丰富的作战经验，擅长从产品、研发、运营角度考虑问题和解决问题。能独立完成人员招聘、团队建设、产品研发、项目管理等工作。
...
擅长：Vue、Vue Router、Vuex、Vue Cli、React、Dva、Umi、Redux、Immutable、Webpack、微前端（已商用）、Webpack5 模块联邦、等前端前言知识。
